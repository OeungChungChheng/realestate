...
<!----Homepage--->
	<div class="container content-box homepage">
		<h3 class="search-heading">
            <i class="fa fa-search"></i>Find your Home
        </h3>
		<div class="container">
			<div class="row">
				<div id="col"> 
...
<!---Back to Top----->
	<!---<button onclick="topFunction()" id="myBtn" title="Go to top" class="backtoTop"><i class="fa fa-caret-up" aria-hidden="true"></i></button>-->
<?php
get_footer();
