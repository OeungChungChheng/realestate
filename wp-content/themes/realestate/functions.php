...
function realestate_scripts() {
	...
	wp_enqueue_style( 'realestate-fonts', realestate_fonts_url(), array(), null );

	// Theme stylesheet.
	wp_enqueue_style( 'realestate-style', get_stylesheet_uri(), array(), '20190507' );

	// Theme block stylesheet.
	wp_enqueue_style( 'realestate-block-style', get_theme_file_uri( '/assets/css/blocks.css' ), array( 'realestate-style' ), '20190105' );

	// Load the dark colorscheme.
	if ( 'dark' === get_theme_mod( 'colorscheme', 'light' ) || is_customize_preview() ) {
		wp_enqueue_style( 'realestate-colors-dark', get_theme_file_uri( '/assets/css/colors-dark.css' ), array( 'realestate-style' ), '20190408' );
	}

	// Load the Internet Explorer 9 specific stylesheet, to fix display issues in the Customizer.
	if ( is_customize_preview() ) {
		wp_enqueue_style( 'realestate-ie9', get_theme_file_uri( '/assets/css/ie9.css' ), array( 'realestate-style' ), '20161202' );
		wp_style_add_data( 'realestate-ie9', 'conditional', 'IE 9' );
	}

	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'realestate-ie8', get_theme_file_uri( '/assets/css/ie8.css' ), array( 'realestate-style' ), '20161202' );
	wp_style_add_data( 'realestate-ie8', 'conditional', 'lt IE 9' );

	// Load the html5 shiv.
	wp_enqueue_script( 'html5', get_theme_file_uri( '/assets/js/html5.js' ), array(), '20161020' );
	wp_script_add_data( 'html5', 'conditional', 'lt IE 9' );

	wp_enqueue_script( 'realestate-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '20161114', true );

	$realestate_l10n = array(
		'quote' => realestate_get_svg( array( 'icon' => 'quote-right' ) ),
	);

	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'realestate-navigation', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '20161203', true );
		$realestate_l10n['expand']   = __( 'Expand child menu', 'realestate' );
		$realestate_l10n['collapse'] = __( 'Collapse child menu', 'realestate' );
		$realestate_l10n['icon']     = realestate_get_svg(
			array(
				'icon'     => 'angle-down',
				'fallback' => true,
			)
	...
	wp_enqueue_script( 'realestate-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '20190121', true );

	wp_enqueue_script( 'jquery-scrollto', get_theme_file_uri( '/assets/js/jquery.scrollTo.js' ), array( 'jquery' ), '2.1.2', true );

	wp_localize_script( 'realestate-skip-link-focus-fix', 'realestateScreenReaderText', $realestate_l10n );
 ...
 */
function realestate_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'realestate-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks.css' ), array(), '20190328' );
	// Add custom fonts.
	wp_enqueue_style( 'realestate-fonts', realestate_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'realestate_block_editor_styles' );
 ...
 */
function realestate_widget_tag_cloud_args( $args ) {
	$args['largest']  = 1;
	$args['smallest'] = 1;
	$args['unit']     = 'em';
	$args['format']   = 'list';
...
add_filter( 'widget_tag_cloud_args', 'realestate_widget_tag_cloud_args' );
 ...
 */
function realestate_unique_id( $prefix = '' ) {
	static $id_counter = 0;
