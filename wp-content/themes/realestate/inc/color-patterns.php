 ...
 */
function realestate_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'realestate_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.realestate-front-page) .entry-title,
...
.colors-custom .realestate-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.realestate-front-page .panel-content .recent-posts article,
...
.colors-custom.realestate-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'realestate_custom_colors_css', $css, $hue, $saturation );
}
